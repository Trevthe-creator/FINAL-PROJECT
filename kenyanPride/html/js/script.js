...
function renderCategories() {
    ...
    categoriesGrid.innerHTML = categories.map((category, index) => `
        <div class="category-card" style="animation-delay: ${index * 0.1}s">
            <img src="https://images.unsplash.com/${category.image}?w=400&h=300&fit=crop" alt="${category.name}">
    ...
    productsGrid.innerHTML = products.map(product => `
        <div class="product-card">
            <div class="product-image">
                <img src="https://images.unsplash.com/${product.image}?w=400&h=300&fit=crop" alt="${product.name}">
                ${product.isOrganic ? '<div class="product-badge badge-organic">Organic</div>' : ''}
...
function updateAuthUI() {
    ...
    if (isLoggedIn) {
        ...
        authBtn.onclick = () => showToast('Profile', 'Profile functionality coming soon!');
    } else {
